    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetMessage(int userId, int id )
        {
            ...
            if (userId != int.Parse(User.FindFirst(ClaimTypes.NameIdentifier).Value))
                return Unauthorized();
            //Gets message from DB using IDatingRepo GetMessage and messageId
        ...
        public async Task<IActionResult> GetMessagesForUser(int userId, [FromQuery]MessageParams messageParams)
        {
            ...
            // Adding userId to our parameters.
        ...
        {
            //Automapper will map sender and recipient properties into MessageToReturn
            ...
            {
                // We can use .ReverseMap in AutoMapper profiles to enable mapping from Message to DTO 
                // which we then return back
